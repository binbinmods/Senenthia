...
namespace Senenthia
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        public static string characterName = "Senenthia";
        public static string heroName = characterName;

        public static string subclassName = "Castle"; // needs caps
        ...
        private void Awake()
        {
            ...
            RegisterMod(
                ...
                _author: "binbin",
                _description: "Senenthia, the Castle.",
                _version: PluginInfo.PLUGIN_VERSION,
                _date: ModDate,
                _link: @"https://github.com/binbinmods/Senenthia",
                _contentFolder: "Senenthia",
